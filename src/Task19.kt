...
class Boeing747(maximumRange: Double, tankCapacity: Double, var passengerCapacity: Int) : Aircraft3(maximumRange, tankCapacity)


open class Aircraft3(var maximumRange: Double, var tankCapacity: Double) {
    val fuelConsumption
